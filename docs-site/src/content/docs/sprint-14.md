---
title: "S14 · Tehdit modeli ve bağımsız test"
description: "Tehdit modeli v2 ve yeniden test raporu."
group: "Sprintler"
---

## Sprint hedefi

Tehdit modeli v2 ve yeniden test raporu. **Planlandı · henüz geliştirilmedi.** Faz 5: Güvenlik & yönetişim. Süre 2 hafta; 10 geliştirme kişi-günü kapsam + 4 gün entegrasyon/review kapasitesi önerisi. [Kapasite varsayımları](/docs/kapsam/).
...
[S15 sprintine geç](/docs/sprint-15/).
